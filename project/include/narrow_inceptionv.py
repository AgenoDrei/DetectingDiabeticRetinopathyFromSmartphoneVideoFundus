...
class Mixed_3a(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv = BasicConv2d(32, 48, kernel_size=3, stride=2)
...
class Mixed_4a(nn.Module):
    ...
    def __init__(self):
        ...
        self.branch0 = nn.Sequential(
            ...
            BasicConv2d(32, 48, kernel_size=3, stride=1)
        )
        ...
        self.branch1 = nn.Sequential(
            ...
            BasicConv2d(32, 48, kernel_size=(3,3), stride=1)
        )
...
class Mixed_5a(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv = BasicConv2d(96, 96, kernel_size=3, stride=2)
        self.maxpool = nn.MaxPool2d(3, stride=2)
...
class Reduction_A(nn.Module):
    ...
    def __init__(self):
        ...
        self.branch0 = BasicConv2d(192, 192, kernel_size=3, stride=2)

        self.branch1 = nn.Sequential(
            BasicConv2d(192, 96, kernel_size=1, stride=1),
            BasicConv2d(96, 112, kernel_size=3, stride=1, padding=1),
            BasicConv2d(112, 128, kernel_size=3, stride=2)
        )
...
class Reduction_B(nn.Module):
    ...
    def __init__(self):
        ...
        self.branch1 = nn.Sequential(
            ...
            BasicConv2d(160, 160, kernel_size=3, stride=2)
        )
...
class NarrowInceptionV1(nn.Module):

    def __init__(self, num_classes=1001):
        super(NarrowInceptionV1, self).__init__()
        # Special attributs
        self.input_space = None
        self.input_size = (299, 299, 6)
        self.mean = None
        self.std = None
        # Modules
        self.features = nn.Sequential(
            BasicConv2d(3, 16, kernel_size=3, stride=2),
            BasicConv2d(16, 16, kernel_size=3, stride=1),
